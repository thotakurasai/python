...
import io
df9 = pd.read_json(io.BytesIO(uploaded['NewsPapers.json']))
...
for company, value in companies.items():
    ...
    if 'rss' in value:
        ...
        #files.download("news_1.csv")

uploaded = drive.CreateFile({'title': 'newsss.csv'})
          
uploaded.SetContentFile('newsss.csv')
