...
tweets = tweepy.Cursor(api.search,q="#entrepreneurs"+" -filter:retweets"
                    #since="2019-09-19",
                    #until="2019-09-20"
                    ).items(298)
...
message,valid_data,collect,list_of_imp_words,favorite_count,tweet_count,retweet_count,created_at,user_name,verified,followers_count,following_count,days=[],[],[],[],[],[],[],[],[],[],[],[],[]
for tweet in tweets:
...
uploaded = drive.CreateFile({'title': 'twitter_sort_1.csv'})
          
uploaded.SetContentFile('twitter_sort_1.csv')
